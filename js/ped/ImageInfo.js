import {GLOBAL as G, setCanvas} from './GLOBAL'
        ...
        let imgBox = `<div style="position: fixed;top: 0;left: 0;right: 0;bottom: 0;overflow: hidden;z-index: 997;background-color: white">`+
                          ...
                          `<div style="position: absolute;bottom: 0;left: 0;right: 0;height: 6rem;background-color: black;display: flex;text-align: center;color: white">`+
                            `<div ${operatingStyle} operate="1">`+
                                `<img src="../../img/markingPapers/painting.png" style="width: 1.3rem;display: block;margin: auto;">涂画`+
                            `</div>`+
                            `<div ${operatingStyle} operate="2">`+
                                `<img src="../../img/markingPapers/text.png" style="width: 1.3rem;display: block;margin: auto"> 文字`+
                            `</div>`+
                            `<div ${operatingStyle} operate="3">`+
                                `<img src="../../img/markingPapers/withdraw.png" style="width: 1.3rem;display: block;margin: auto"> 撤回`+
                            `</div>`+
                            `<div ${operatingStyle} operate="4">`+
                                `<img src="../../img/markingPapers/empty.png" style="width: 1.3rem;display: block;margin: auto"> 清空`+
                            `</div>`+
                          `</div>`+
