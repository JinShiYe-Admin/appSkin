	...
	return function(t) {
		...
		function c() {
			...
			console.log(t.style.color), "rgb(69, 148, 248)" == t.style.color && (t.firstChild.src =
				"./image/painting.png", t.style.color = "white")
		}
			...
			i(document.querySelectorAll(".picture-operate")).forEach(function(t) {
				t.addEventListener("click", function(t) {
					...
					if (function(t) {
						...
						o.firstChild.src = "./image/painting1.png", o.style
							.color = "#4594f8"
					...
					var t =
						...
						e = r(
							...
							'<canvas id="picture_edit_canvas" width="'.concat(n.img
								...
								.img._WH) + "px", '"></canvas>') +
							'</div></div><div style="position: absolute;bottom: 0;left: 0;right: 0;height: 6rem;background-color: black;display: flex;text-align: center;color: white">' +
							"<div ".concat(t, ' operate="1">') +
							'<img src="./image/painting.png" style="width: 1.3rem;display: block;margin: auto;">涂画</div>' +
							"<div ".concat(t, ' operate="2">') +
							'<img src="./image/text.png" style="width: 1.3rem;display: block;margin: auto"> 文字</div>' +
							"<div ".concat(t, ' operate="3">') +
							'<img src="./image/withdraw.png" style="width: 1.3rem;display: block;margin: auto"> 撤回</div>' +
							"<div ".concat(t, ' operate="4">') +
							'<img src="./image/empty.png" style="width: 1.3rem;display: block;margin: auto"> 清空</div></div><div id="picture_edit_text" style="position: absolute;top: 0;left: 0;right: 0;bottom: 0;overflow: hidden;z-index: 2;display: none;background-color: white;opacity: 0.93"></div><div id="picture_edit_input" contenteditable="true" tabindex="1" style="min-height:15%;border-radius: 5px;border: 2px solid #63eca1;outline: none;width: 96%;box-sizing: border-box;position: absolute;top: 8%;left: 2%;right: 2%;display: none;z-index: 2;padding: 3px 5px"></div></div>'
							);
