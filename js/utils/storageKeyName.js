...
var storageKeyName = (function(mod) {
	...
	switch(mod.key) {
		case 1: //山东开发
			...
			mod.INTERFACE_BASESUB = 'http://develop309.jiaobaowang.net/testbaseapi/api/Data/';//统一信息接口:考务、家校互动用(顾)
			mod.INTERFACE_EXAMINATION = 'http://develop309.jiaobaowang.net/stuzy/api/paper/';//考务系统接口(蒙)
			mod.INTERFACE_WORK = 'http://develop309.jiaobaowang.net/stukqsubapi/attendance/';//学生考勤系统接口(阮)
		...
		case 2: //广西开发
			...
			mod.INTERFACE_BASESUB = '? 需连山东开发环境';//统一信息接口:考务用(顾)
			mod.INTERFACE_EXAMINATION = '? 需连山东开发环境';//考务系统接口(蒙)
			mod.INTERFACE_WORK = '? 需连山东开发环境';//学生考勤系统接口(阮)
